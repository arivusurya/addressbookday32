...
insert into AddressBook(firstName,lastName,address,city,state,zip,phoneNumber,email,Name,Type) values('ares','kratos','olympia','rome','greek','443301','9234927342','ares@gmail.com','ares','Friend');
insert into AddressBook(firstName,lastName,address,city,state,zip,phoneNumber,email,Name,Type) values('ares','kratos','olympia','rome','greek','443301','9234927342','ares@gmail.com','ares','Family');
